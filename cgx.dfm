...
pointTagLabelStyle = 
pointLabelStyle = active desckeys only
...
curveLabelStyle = length above, radius below
lineLabelOnEntity = 1
lineTagLabelStyle = Tag Number
lineLabelStyle = direction above, distance below
updateLabelOnStyleChange = 1
updateLabelOnEntChange = 1
trackCoordinates = 0
doubleClickCommand = _.properties
